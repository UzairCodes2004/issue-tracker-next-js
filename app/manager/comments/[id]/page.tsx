...
export default function ManagerCommentDetailPage() {
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <button
            onClick={() => router.push("/manager/comments")}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6">
        ...
        <div className="border-t border-slate-200 pt-4 space-y-2 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href={`/manager/issues/${comment.issue?.id}`}
      ...
      <div className="flex gap-3">
        <Button
          asChild
          className="bg-amber-600 hover:bg-amber-700 text-white font-medium px-4 py-2 rounded-lg"
        >
          <Link href={`/manager/issues/${comment.issue?.id}`}>View Related Issue</Link>
        </Button>
        <Button
          onClick={() => setShowConfirm(true)}
