            ...
            <div className="flex items-center gap-4">
                ...
                {status === 'authenticated' && session?.user && (
                    <DropdownMenu.Root>
                        ...
                        <DropdownMenu.Content align="end" className="w-48">
                            <DropdownMenu.Item>
                                <Link href={`/users/${(session.user as any).id}`} className="w-full">
                                    Profile
                                </Link>
                            </DropdownMenu.Item>
                ...
                {status === 'unauthenticated' && (
                    <div className="hidden md:flex items-center gap-3">
                        <Link href="/login" className="text-sm bg-indigo-600 text-white px-4 py-1.5 rounded-full hover:bg-indigo-700 transition-colors shadow-sm">
                            Log in
                        </Link>
                        <Link
                            href="/register"
